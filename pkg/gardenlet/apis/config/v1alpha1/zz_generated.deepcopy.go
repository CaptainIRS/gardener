...
func (in *ETCDConfig) DeepCopyInto(out *ETCDConfig) {
	*out = *in
	...
	if in.OperatorConfig != nil {
		...
		*out = new(EtcdDruidOperatorConfiguration)
		(*in).DeepCopyInto(*out)
	}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *EtcdDruidOperatorConfiguration) DeepCopyInto(out *EtcdDruidOperatorConfiguration) {
	*out = *in
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new ETCDOperatorConfiguration.
func (in *EtcdDruidOperatorConfiguration) DeepCopy() *EtcdDruidOperatorConfiguration {
	if in == nil {
		return nil
	}
	out := new(EtcdDruidOperatorConfiguration)
